...
const SEED_AUTOMATIONS = [
  {
    ...
    steps: [
      {
        delayDays: 0,
        subject: 'Welcome to Veil — here\'s 15% off',
        html: eyebrow('Welcome to Veil')
          + heading("You're in.")
          + image('Veil Original', 'https://veilpuff.com/images/veil-original-scent.png')
          + p("A soft veil of jasmine, vanilla, and warm woods — swept on, not sprayed on. As a thank-you for joining, here's 15% off your first order, already applied below.")
          + code('WELCOME15')
    ...
    steps: [
      {
        ...
        html: eyebrow('Checking in')
          ...
          + code('WELCOME15')
          + button('Yes, keep me updated', 'https://veilpuff.com/shop?discount=WELCOME15'),
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        html: eyebrow('15% off, on us')
          + heading('One more reason to say yes.')
          + p("Still on the fence? Here's 15% off to help you decide.")
          + '{{CART_ITEMS}}'
          + code('WELCOME15')
          + button('Complete my order — 15% off applied', 'https://veilpuff.com/checkout?discount=WELCOME15'),
      },
    ],
  },
  {
